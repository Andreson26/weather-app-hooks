...
import getFormattedtWeatherData from './services/weatherService';
import { ToastContainer, toast } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';

function App() {

  const [query, setQuery] = useState({q: 'charlotte'});
   ...
   useEffect(() => {
    const fetchWeather = async() => {
      ...
      toast.info("fetching weather for " + message);
       ...
       await getFormattedtWeatherData( {...query, units}).then(data => {
