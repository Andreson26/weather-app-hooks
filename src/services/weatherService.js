...
const API_KEY="31817d0def20e7588d7dbdf9539a3055"
...
const formatCurrentWeather = (data) => {
    ...
    return {lat, lon, temp, temp_max, temp_min, feels_like, name, humidity, dt, country, sunrise, sunset, weather, speed, details, icon}
}
